...
int main() {
  ...
  if (system("mkfs.ocfs2 -F -C 4K --cluster-stack=o2cb --cluster-name=syzkaller /dev/loop99")) {
  ...
  if (system("sudo mount -t ocfs2 -o cluster_stack=o2cb,cluster_name=syzkaller /dev/loop99 /mnt/test") !=
      0) {
